...
<link rel="stylesheet" type="text/css" href="/css/al/common.css?55342921475" /><link rel="stylesheet" type="text/css" href="/css/al/fonts_cnt.css?2660709036" />
...
var vk = {
  ...
  tnsPixelType: 'unauth'
};;vk.rv="16892";;if (!window.constants) { window.constants = {Groups: {
...
var StaticFiles = {
  'cmodules/web/common_web.js' : {v: 14},
  'common.css' : {v: 55342921475},'fonts_cnt.css' : {v: 2660709036}
  ,'lang0_0.js': {v: 25644151},'docs.js':{v:995211544},'uncommon.css':{v:16038966019},'fifa2018.js':{v:1},'time_spent.js':{v:732637085},'cmodules/web/page_layout.js':{v:2535703256},'ui_common.js':{v:2022847806},'ui_common.css':{v:15365445019},'audioplayer.js':{v:152875112379},'cmodules/web/likes.js':{v:1},'cmodules/web/grip.js':{v:4164501492}
}
var abp;
</script>

<link type="text/css" rel="stylesheet" href="/css/al/uncommon.css?16038966019"></link><link type="text/css" rel="stylesheet" href="/css/al/ui_common.css?15365445019"></link><script type="text/javascript" src="/js/loader_nav8136934818700_0.js"></script><script type="text/javascript" src="/js/cmodules/web/common_web.js?14_131097255620"></script><script type="text/javascript" src="/js/lang0_0.js?25644151"></script><script type="text/javascript" src="/js/lib/px.js?ch=1"></script><script type="text/javascript" src="/js/lib/px.js?ch=2"></script><meta name="robots" content="noindex" /><script type="text/javascript" src="/js/al/docs.js?995211544"></script><script type="text/javascript" src="/js/cmodules/web/fifa2018.js?1"></script><script type="text/javascript" src="/js/al/time_spent.js?732637085"></script><script type="text/javascript" src="/js/cmodules/web/page_layout.js?2535703256"></script><script type="text/javascript" src="/js/al/ui_common.js?2022847806"></script><script type="text/javascript" src="/js/cmodules/web/audioplayer.js?152875112379"></script><script type="text/javascript" src="/js/cmodules/web/likes.js?1"></script><script type="text/javascript" src="/js/cmodules/web/grip.js?4164501492"></script>
...
<body onresize="onBodyResize()" class="mobfixed ">
  ...
  <div class="head_nav_item fl_r"><a class="top_nav_link" href="" id="top_switch_lang" style="display: none;" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 3, hash: 'c17b84576f57b5e29b' }); return false;">
  Switch to English
...
<div id="ts_cont_wrap" class="ts_cont_wrap" ontouchstart="event.cancelBubble = true;" onmousedown="event.cancelBubble = true;"></div>
  ...
  <form method="POST" name="login" id="quick_login_form" action="https://login.vk.com/?act=login">
    ...
    <input type="hidden" name="ip_h" value="89ec9ced90106a94f6" />
    <input type="hidden" name="lg_h" value="e498ecbb117de44a5a" />
  ...
  <div class="footer_lang fl_r">Язык:<a class="footer_lang_link" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 3, hash: 'c17b84576f57b5e29b'})">English</a><a class="footer_lang_link" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 0, hash: 'c17b84576f57b5e29b'})">Русский</a><a class="footer_lang_link" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 1, hash: 'c17b84576f57b5e29b'})">Українська</a><a class="footer_lang_link" onclick="if (vk.al) { showBox('lang.php', {act: 'lang_dialog', all: 1}, {params: {dark: true, bodyStyle: 'padding: 0px'}, noreload: true}); } else { changeLang(1); } return false;">все языки &raquo;</a></div>
...
window.handlePageParams && handlePageParams({"id":0,"no_ads":1,"loc":"?act=s&api=1&did=477949947&dl=GE3TQNJRGMYTCNQ%3A1538408259%3A5b9829dc44e99abb3f&hash=6ffe90757dea1af9e9&no_preview=1&oid=312069491","wrap_page":1,"width":960,"width_dec":165,"width_dec_footer":165,"top_home_link_class":"top_home_link fl_l ","body_class":"mobfixed ","counters":"","pvbig":0,"pvdark":1});addEvent(document, 'click', onDocumentClick);
...
addLangKeys({"global_fifa_confetti_text":"Г-О-О-О-О-О-Л&#33;"});
addTemplates({"_":"_","stickers_sticker_url":"https:\/\/vk.com\/stickers_proxy.php?act=_sticker&sticker_id=%id%&size=%size%"});
